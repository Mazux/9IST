-- This script is used to control basically even moving disaster in the game.

-- Internal documentation isn't here, I wasn't bothered to include it.

-- I DID NOT CREATE ALL OF THIS. PART OF THIS IS A TEMPLATE.
